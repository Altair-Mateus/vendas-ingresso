...
export class EventModel{
    ...
    static async create(
        ...
        const [result] = await db.execute<ResultSetHeader>(
            ...
            [data.name, data.description, data.date, data.location, created_at, data.partner_id]
        );
    ...
    async update(): Promise<void>{
        ...
        const [result] = await db.execute<ResultSetHeader>(
            ...
            [this.name, this.description, this.date, this.location, this.partner_id, this.id]
        );
