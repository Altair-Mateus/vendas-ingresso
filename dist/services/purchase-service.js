...
class PurchaseService {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const customer = yield customer_model_1.CustomerModel.findById(data.customerId, { user: true, });
            if (!customer) {
                throw new Error("Customer not found");
            }
            const tickets = yield ticket_model_1.TicketModel.findAll({ where: { ids: data.ticketIds }, });
