...
class UserModel {
    ...
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [userResult] = yield db.execute("INSERT INTO users (name, email, password,  created_at) VALUES (?, ?, ?, ?)", [
                data.name, data.email, hashedPassword, created_at
            ]);
            const user = new UserModel(Object.assign(Object.assign({}, data), { password: hashedPassword, created_at, id: userResult.insertId }));
            return user;
        });
    }
