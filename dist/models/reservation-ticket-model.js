...
class ReservationTicketModel {
    ...
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [result] = yield db.execute("INSERT INTO reservation_tickets (customer_id, ticket_id, status, reservation_date) VALUES (?, ?, ?, ?)", [data.customer_id, data.ticketi_id, data.status, reservation_date]);
    ...
    static findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return rows.length ? new ReservationTicketModel(rows[0]) : null;
        });
    }
    static findAll() {
        return __awaiter(this, void 0, void 0, function* () {
